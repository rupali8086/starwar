...
function resetCharacters(){
    return{
      'obiWanKenobi':{name:'Obi-Wan Kenobi',health:120,attack:8,imageUrl:'assets/images/obi.jpg',enemyAttackBack:15},
      'lukeSkywalker':{name:'Luke Skywalker',health:100,attack:14,imageUrl:'assets/images/luke.jpg',enemyAttackBack:5},
      'darthSidious':{name:'Darth Sidious',health:150,attack:8,imageUrl:'assets/images/darth.jpg',enemyAttackBack:20},
      'darthMaul':{name:'Darth Maul',health:180,attack:7,imageUrl:'assets/images/maul.jpg',enemyAttackBack:25}
    }
}
...
function emptyDivs(){
  ...
  $(document).ready(function(){$('#character-area').on('click','.character',function(){
